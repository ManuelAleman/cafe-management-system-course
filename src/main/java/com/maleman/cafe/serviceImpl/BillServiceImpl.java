...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if(validateRequestMap(requestMap)) {
                ...
                JSONArray jsonArray = CafeUtils.getJsonString((String) requestMap.get("productDetails"));
                ...
                return new ResponseEntity<>("{\"uuid\":\"Report generated successfully\": \"" + fileName +" }"
                        , HttpStatus.OK);
            }
            return CafeUtils.getResponseEntity("Required dato not found", HttpStatus.BAD_REQUEST);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public ResponseEntity<List<Bill>> getBills() {
        ...
        if(jwtFilter.isAdmin()){
            ...
            list = billDao.getBillsByUserName(jwtFilter.getCurrentUserEmail());
        }
    ...
    private void addTableHeader(PdfPTable table) {
        ...
        Color columnColor = new Color(250, 193, 77);
        ...
        Stream.of("Name", "Category", "Quantity", "Price", "Sub Total").forEach(columnTitle -> {
            ...
            header.setBackgroundColor(new BaseColor(columnColor.getRGB()));
